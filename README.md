...
./.venv/bin/ci-defect-assistant chat --user-id u001 --conversation-id demo --text "确认"
unset JENKINS_MOCK
```
...
```bash
./.venv/bin/ci-defect-assistant chat --user-id u001 --conversation-id bug-demo --text "创建缺陷 title: 登录失败 description: 点击保存后无响应"
```
